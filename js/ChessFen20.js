...
DG.ChessFen20 = function (config) {
    var properties = ["fen", "labels", "autoFlip", "font"];
...
$.extend(DG.ChessFen20.prototype, {
    ...
    lightSquare: "images/square-light.png",
    darkSquare: "images/square-dark.png",

    font: "alpha",

    labels: true,
    labelFontSizeRatioOfBoard: 1 / 20,
    ...
    renderRankLabels: function () {
        ...
        var fontSize = this.el.width() * this.labelFontSizeRatioOfBoard;
        for (var i = 1; i <= 8; i++) {
    ...
    renderFileLabels: function () {
        ...
        for (var i = 0; i < 8; i++) {
            ...
            rankEl.css({
                "font-size": this.el.width() * this.labelFontSizeRatioOfBoard,
                "float": "left",
                "width": (100 / 8) + "%",
                "text-align": "center",
                "padding-top": 2,
